...
**Cubre:** epic 002, fase 1, la parte con LLM. Único escenario del epic que gasta tokens, y dueño de `registros.md`, el fixture que los otros nueve consumen.
...
- Para la verificación del agente, el fixture `vacio`, igual que [`002-001`](002-001-registro-en-su-dia.md): tiene que trabajar sobre el mismo vault que tenía el autor al dictar.
