...
El segundo pase de un cierre correcto es, por construcción, un cierre sin pareja. Que los dos den el mismo reporte hace al janitor idempotente sin llevar estado.

## Lo que este escenario deja fuera

El cierre **no literal**, cuando el dictado no repite el texto palabra por palabra: deja de ser paso 5 y pasa a juicio del agente ([`spec/agente.md`](../../spec/agente.md)), que ante la duda confirma. Entra en [`002-010`](002-010-dictado-del-dia-uno.md).
