"""Test del escenario 001-01-instalacion-con-uv-tool.
...
@pytest.mark.red
@pytest.mark.lento
def test_001_01_uv_tool_install_deja_tuku_y_puebla_tuku_home() -> None:
...
if __name__ == "__main__":
    test_001_01_uv_tool_install_deja_tuku_y_puebla_tuku_home()
