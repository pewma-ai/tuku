...
La corrida instala en `playground/001-002-instalacion-local/` (git-ignored,
se pisa en cada corrida), así el resultado queda a la vista para compararlo
a mano contra el de 001-001.
...
def test_001_002_instalacion_local_coincide_con_001_001() -> None:
    destino = preparar_playground("001-002-instalacion-local")
