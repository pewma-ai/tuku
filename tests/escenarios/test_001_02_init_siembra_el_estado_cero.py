"""Test byte a byte del escenario 001-02-init-siembra-el-estado-cero.

Escenario: 001-02-init-siembra-el-estado-cero.md
...
Ejecutable directo:
`python3 tests/escenarios/test_001_02_init_siembra_el_estado_cero.py`
"""
...
if __name__ == "__main__":
    test_001_02_init_siembra_el_estado_cero_byte_a_byte()
    print(
        "ok: árbol idéntico a template/vanilla/, AHORA.md sembrado, sin placeholders vivos "
        "(queda en playground/001-02-init-siembra-el-estado-cero/)"
    )
