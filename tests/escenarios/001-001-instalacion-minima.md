...
## Escenario: alguien sin conocimientos de informática instala TUKU y escribe su primer registro
...
Entonces el registro queda bien formado sin haber leído `spec/`, solo `AGENTS.md` y `LIBRO-DE-ESTILO.md`
...
- Cronometrar cuánto toma escribir el primer registro sin haber leído nada más que `AGENTS.md`. Si toma releer `spec/`, la fase 0 no está cumplida.
