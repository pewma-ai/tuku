...
Y la de las 18:40 sigue escrita tal cual, sin reescribirse al insertar las otras dos
...
Deja el vault en `playground/002-001-entrada-en-su-dia/`, estado inicial del paso siguiente.

## Qué se mira a mano

- Leer el martes 11 en Obsidian como lo leería el autor: que las tres entradas se entiendan sin la conversación que las originó (principio 2 de `spec/bitacora.md`).
- Que la entrada de las 18:40, sin ámbito ni clasificación, no se vea coja al lado de las otras dos.
