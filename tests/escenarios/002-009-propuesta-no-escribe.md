...
**Cubre:** epic 002. El principio 3 en test: la propuesta se muestra y espera, y rechazarla no deja rastro. Es la prueba dura del epic 005 anticipada barato, sobre la única consecuencia que a propósito no tiene janitor.

## Estado inicial

El que dejó [`002-008-crear-nota`](002-008-crear-nota.md). Último paso determinista de la cadena: su estado final es el que se revisa contra el criterio de salida del epic.
...
Una propuesta rechazada no escribe nada, así que no hay nada que limpiar: por eso es la única consecuencia sin janitor ([`spec/flujo-informacion.md`](../../spec/flujo-informacion.md)).
...
El escenario aprueba y revierte, para que [`002-010`](002-010-dictado-del-dia-uno.md) herede el estado del rechazo: el día uno del corpus termina sin ese pendiente.
