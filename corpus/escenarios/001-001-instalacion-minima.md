...
`../../tests/escenarios/test_001_001_instalacion_minima.py` fija la fecha en **2026-08-11** (martes), el mismo día donde arranca el ground truth de `corpus/referencia/referencia-developer.md` ("Turno Faena"), y compara contra el fixture en `../../tests/escenarios/fixtures/001-001-instalacion-minima/esperado/`.
