...
| 003 | El día uno, dictado | `vacio` → `primer-dia` | por cerrar | siete escenarios en verde (`003-01` a `003-07`). Falta revisión a mano de los `turno-1.md` de `playground/003-*` contra criterio de salida |
