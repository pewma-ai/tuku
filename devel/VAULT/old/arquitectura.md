...
> `docs/arquitectura.md` · La forma del sistema. Se apoya en [`brief.md#3-principios`](devel/VAULT/old/brief.md#3-principios) y precede a `spec/`, que fija los formatos exactos.
