...
| **Round-trip byte-a-byte** | Lectura/escritura de archivos canónicos no debe alterar espacios ni comentarios HTML (ADR 0013/0014). |
| **Modelos internos** | Toda entidad interna debe usar `pydantic.BaseModel` v2 (ADR 0017). |
