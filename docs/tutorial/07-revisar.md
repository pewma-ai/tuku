...
Este es el segundo y último comando que corres tú. Desde dentro de la carpeta:

```bash
tuku doctor
```

## Lee la salida entera
...
> [!tip] Ahora hazlo enojar
> Abre `PENDIENTES.md` tú misma y borra una fila entera.
