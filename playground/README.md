...
Un directorio por escenario, con **el mismo nombre del escenario** que lo generó: `XXX-YYY-slug/`, igual que `../tests/escenarios/XXX-YYY-slug.md`. Así el resultado dice de qué caso salió, y volver a correrlo sobrescribe el anterior en vez de acumular carpetas.
